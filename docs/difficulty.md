...
should be numbers (starting with 1). 
...
In the id_difficulty file, store the organism key of each taxon, along side the difficulty code for identifying that taxa.

organism_key | taxon | code
------------ | ----- | ----
NBNORG0000011292 | Agenioideus cinctellus | 3
NBNORG0000072027 | Agenioideus sericeus | 5
NBNORG0000072030 | Ammophila sabulosa | 2
